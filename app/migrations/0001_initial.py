...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'ChatRooms',
                'verbose_name_plural': 'ChatRooms',
            },
        ),
        migrations.CreateModel(
            name='UsersInChatRooms',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chat_room_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.chatrooms')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'UsersInChatRooms',
                'verbose_name_plural': 'UsersInChatRooms',
            },
        ),
        migrations.CreateModel(
            name='Messages',
